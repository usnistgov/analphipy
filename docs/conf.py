...
project = "analphipy"
copyright = "2021, William P. Krekelberg"  # ruff:ignore[builtin-variable-shadowing]
...
release = version = analphipy.__version__
...
htmlhelp_basename = "analphipydoc"
...
def linkcode_resolve(domain: str, info: dict[str, Any]) -> str | None:
    ...
    # fmt: off
    fn = os.path.relpath(fn, start=Path(analphipy.__file__).parent)
    # fmt: on
